...
3. Using the correct formatting from the GET request, submit data to the POST sandbox endpoint to produce each type of output (Approved, Manual Review, Denied, Error).
...
From my observations, the only way to produce an error response was to enter anything besides "US" in the country field.   
